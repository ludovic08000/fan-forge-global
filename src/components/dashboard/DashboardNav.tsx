...
export type DashboardSection = 'overview' | 'content' | 'live' | 'messages' | 'analytics' | 'auctions' | 'bundles' | 'wishlists' | 'polls' | 'partnerships' | 'payments' | 'pricing' | 'ai-marketing' | 'settings';
