/**
 * Composant pour envoyer des tips/pourboires dans le chat live
 */
...
export const LiveTipButton = ({ liveStreamId, creatorId, creatorName }: LiveTipButtonProps) => {
  const { user } = useAuth();
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button 
          variant="outline" 
          size="sm" 
          className="gap-1.5 border-amber-500/50 text-amber-600 hover:bg-amber-500/10 hover:text-amber-500"
        >
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Super live ! Continue comme ça 💪"
              maxLength={200}
              rows={2}
            />
          ...
          <p className="text-xs text-muted-foreground text-center">
            Paiement sécurisé par Stripe. 90% vont au créateur.
          </p>
        </div>
      </DialogContent>
    </Dialog>
