...
import { SmsVerification } from '@/components/security/SmsVerification';
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-lg border">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Connexion traditionnelle</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Connexion rapide avec Google</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Connexion avec Facebook</p>
                  </div>
                </div>
                <span className="text-sm text-muted-foreground">Disponible</span>
              </div>
