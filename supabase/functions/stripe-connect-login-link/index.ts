...
serve(async (req) => {
  ...
  // Add Cross-Origin-Opener-Policy for Stripe popup compatibility
  ...
  try {
    ...
    return new Response(
      ...
      { headers: { ...corsHeaders, "Cross-Origin-Opener-Policy": "unsafe-none", "Content-Type": "application/json" }, status: 400 }
    );
  }
});
