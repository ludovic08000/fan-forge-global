...
-- Mettre à jour la fonction pour ne compter que les tips avec stripe_payment_intent_id (réellement payés)
...
BEGIN
  ...
  -- Tips revenue - SEULEMENT les tips avec stripe_payment_intent_id (réellement payés)
